...
function recipe_breakfast(){
	...
	// Permet de compiler les données en un fichier JSON
...
function print_recipes_posts($query){
	...
	// Si on n'est pas dans l'interface d'admin et que c'est la requête principale
	if(!is_admin() && $query->is_main_query()){

		// Ajout des posts et des recipes à la home
		if(is_home()){
